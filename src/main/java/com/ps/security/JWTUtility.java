...
import com.ps.utility.TimeProvider;
...
public class JWTUtility implements Serializable {
    private static final long serialVersionUID=234155277910L;
    @Value("${app.name}")
    ...
    private Date generateExpirationDate(Device device) {
        ...
        if(device!=null)
         expiresIn = device.isTablet() || device.isMobile() ? MOBILE_EXPIRES_IN : EXPIRES_IN;
